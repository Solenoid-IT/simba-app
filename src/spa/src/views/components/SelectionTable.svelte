...
<div class="row">
    <div class="col">
        <Table resourceType="Available" bind:api={ availableTable } bind:records={ availableRecords } selectable minimal={ minimal } on:selection.change={ onAvailableSelectionChange }/>
    </div>
    ...
    <div class="col">
        <Table resourceType="Selected" input={ input } required={ required } controls bind:api={ selectedTable } bind:records={ selectedRecords } selectable minimal={ minimal } on:selection.change={ onSelectedSelectionChange } on:record.action={ onSelectedRecordAction }/>
    </div>
</div>
